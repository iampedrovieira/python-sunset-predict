...
image_url = "https://sunsetwx.com/sunset/gfssunset_eu_f2.png"
json_data = process_sunset_image_from_url(image_url)

# Save output
with open("sunset_forecast_auto_bounds.json", "w") as f:
    json.dump(json_data, f, indent=2)

# Preview some data points
print(json.dumps(json_data["data"][:5], indent=2))
